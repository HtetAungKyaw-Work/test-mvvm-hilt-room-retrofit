package com.haker.test_mvvm_hilt_room_retrofit.adapter
...
import com.haker.test_mvvm_hilt_room_retrofit.databinding.ItemArticlePreviewBinding
        ...
        fun bind(article: Article){
            binding.apply {
                Glide.with(itemView)
                    ...
                    .into(ivArticleImage)
                Log.i("urlToImage", article.urlToImage.toString())
